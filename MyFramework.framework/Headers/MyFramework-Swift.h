...
SWIFT_PROTOCOL("_TtP11MyFramework33NetworkReachabilityHelperDelegate_")
@protocol NetworkReachabilityHelperDelegate
@optional
- (void)networkBecomeNotReachable;
- (void)networkBecomeWwanType;
- (void)networkBecomeEthernetOrWifi;
- (void)networkConditionUnknown;
@end
